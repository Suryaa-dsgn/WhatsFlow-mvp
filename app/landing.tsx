...
import MockPlayground from './components/MockPlayground';
...
const features = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-whatsapp">
...
export default function LandingPage() {
  ...
  return (
    <div className="bg-gray-50 overflow-auto">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-10">
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                href="/onboarding" 
                className="px-8 py-4 bg-whatsapp text-white rounded-[8px] shadow-lg hover:bg-whatsapp-dark transition-colors"
              >
                Get Started with WhatsFlow
              </Link>
              <button 
                onClick={openDemoVideo} 
                className="px-8 py-4 bg-white text-whatsapp border border-whatsapp rounded-[8px] shadow-md hover:bg-gray-50 transition-colors"
              >
                Watch Demo
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center transition-opacity duration-300">
          <div className="relative w-full max-w-5xl bg-white rounded-lg shadow-2xl overflow-hidden">
            <button 
              ...
              className="absolute top-4 right-4 z-10 text-white rounded-full p-2 transition-colors bg-black/20 hover:bg-black/40"
            ...
            <div className="aspect-video w-full bg-black relative">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-900 opacity-0 pointer-events-none">
                ...
                <button 
                  className="mt-4 px-6 py-2 bg-whatsapp text-white rounded-lg"
                  onClick={closeDemoVideo}
                >
                  Close
                </button>
                    ...
                    <ul className="space-y-3">
                      {[
                        ...
                        <li key={index} className="flex items-start">
                          <svg className="w-5 h-5 text-whatsapp mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature) => (
              ...
              >
                ...
                <div className="mt-4">
                  <a href="#" className="text-whatsapp font-medium flex items-center hover:underline">
                    Learn more
            ...
            {testimonials.map((testimonial) => (
              ...
              >
                ...
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-xl font-bold text-whatsapp mr-4">
      ...
      <div className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-whatsapp to-whatsapp-dark rounded-2xl shadow-xl p-12 text-white text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link 
                href="/onboarding" 
                className="px-8 py-4 bg-white text-whatsapp font-medium rounded-[8px] shadow-lg hover:bg-gray-100 transition-colors"
              >
                Get Started with WhatsFlow
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h2 className="text-2xl font-bold text-whatsapp mb-2">WhatsFlow</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16">
              <div>
                ...
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Features</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Pricing</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Demo</a></li>
                </ul>
              </div>
              <div>
                <h3 className="font-bold mb-4">Resources</h3>
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Documentation</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Blog</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Guides</a></li>
                </ul>
              </div>
              <div>
                <h3 className="font-bold mb-4">Company</h3>
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">About</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Careers</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Contact</a></li>
                </ul>
              </div>
              <div>
                <h3 className="font-bold mb-4">Legal</h3>
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Privacy</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Terms</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-whatsapp">Security</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-600 hover:text-whatsapp">
