...
import ChatMessage from '../../whatsflow-onboarding/src/components/chat/ChatMessage';
    ...
    return (
      <div className="mb-16 relative">
        ...
        <div className="hidden md:flex justify-between items-center w-full max-w-3xl mx-auto relative">
          ...
          <div 
            className="absolute top-5 left-0 h-0.5 bg-whatsapp z-0" 
            style={{ 
          ...
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col items-center relative z-10">
              ...
              <span className={`text-xs mt-2 font-medium ${
                currentStep > index + 1 ? 'text-whatsapp' : currentStep === index + 1 ? 'text-whatsapp' : 'text-gray-400'
              }`}>
                {step.title}
              </span>
            </div>
        ...
        <div className="mb-10">
          ...
          {currentStep === 1 && (
            <div 
              ...
              ${currentStep === 1 ? 'border-2 border-whatsapp' : 'border border-gray-200'}`}>
                  ...
                  <div
                    ...
                    className={`p-4 rounded-xl cursor-pointer transition-all duration-200 hover:shadow-md ${
                      businessType === type.id 
                        ? 'border-2 border-whatsapp bg-whatsapp/10' 
                        : 'border-2 border-gray-200 hover:border-whatsapp'
                    }`}
                  >
                    <div className="flex items-center">
                      ...
                      {businessType === type.id && (
                        <svg className="w-5 h-5 text-whatsapp ml-auto" fill="currentColor" viewBox="0 0 20 20">
          ...
          {currentStep === 2 && (
            <div className={`bg-white rounded-2xl shadow-md p-8 transition-all hover:shadow-lg
              ${currentStep === 2 ? 'border-2 border-whatsapp' : 'border border-gray-200'}`}>
              ...
              <div className="space-y-6">
                <div className="group">
                  <label htmlFor="business-name" className="block text-sm font-medium transition-colors group-hover:text-whatsapp focus-within:text-whatsapp mb-1">
                  ...
                  <div className="relative rounded-md shadow-sm focus-within:z-10">
                    <input
                      ...
                      className="block w-full rounded-2xl border transition-colors py-3 px-4 
                        focus:outline-none focus:ring-2 focus:ring-whatsapp focus:border-whatsapp
                        group-hover:border-whatsapp border-gray-300"
                ...
                <div className="group">
                  <label htmlFor="business-website" className="block text-sm font-medium transition-colors group-hover:text-whatsapp focus-within:text-whatsapp mb-1">
                    Website (optional)
                  </label>
                  <div className="relative rounded-md shadow-sm focus-within:z-10">
                    <input
                ...
                <div className="group">
                  <label htmlFor="business-size" className="block text-sm font-medium transition-colors group-hover:text-whatsapp focus-within:text-whatsapp mb-1">
                ...
                <div className="group">
                  <label htmlFor="business-region" className="block text-sm font-medium transition-colors group-hover:text-whatsapp focus-within:text-whatsapp mb-1">
          ...
          {currentStep === 3 && (
            <div className={`bg-white rounded-2xl shadow-md p-8 transition-all hover:shadow-lg
              ${currentStep === 3 ? 'border-2 border-whatsapp' : 'border border-gray-200'}`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    ...
                    className={`relative p-4 rounded-xl border-2 cursor-pointer transition-all duration-200 hover:shadow-md overflow-hidden ${
                      businessGoals.includes(goal.id) 
                        ? 'border-whatsapp bg-gradient-to-br from-whatsapp/10 to-whatsapp/5' 
                        : 'border-gray-200 hover:border-gray-300'
                    }`}
                  >
                    {businessGoals.includes(goal.id) && (
                      <div className="absolute top-0 right-0 h-12 w-12 -mr-6 -mt-6 bg-whatsapp/20 transform rotate-45"></div>
                    )}
                    <div className="flex items-start">
                      <div className="flex h-5 items-center mt-1">
                        <input
                          id={goal.id}
                          type="checkbox"
                          className="h-5 w-5 rounded border-gray-300 text-whatsapp focus:ring-whatsapp transition-all"
                      ...
                      {businessGoals.includes(goal.id) && (
                        <div className="flex-shrink-0 self-start">
                          <svg className="w-5 h-5 text-whatsapp" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                          </svg>
                        </div>
                      )}
          ...
          {currentStep === 4 && (
            <div className={`bg-white rounded-2xl shadow-md p-8 transition-all hover:shadow-lg
              ${currentStep === 4 ? 'border-2 border-whatsapp' : 'border border-gray-200'}`}>
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  >
                    ...
                    {communicationStyle === style.id && (
                      <svg className="w-5 h-5 text-whatsapp ml-2" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                      </svg>
                    )}
                  </div>
          ...
          {currentStep === 5 && (
            <div className={`bg-white rounded-2xl shadow-md p-8 transition-all hover:shadow-lg
              ${currentStep === 5 ? 'border-2 border-whatsapp' : 'border border-gray-200'}`}>
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-5 rounded-xl border border-gray-200 hover:shadow-sm transition-all">
                  <div className="flex items-center mb-2">
                    <svg className="w-5 h-5 text-whatsapp mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="bg-gray-50 p-5 rounded-xl border border-gray-200 hover:shadow-sm transition-all">
                  ...
                  <div className="flex flex-wrap gap-2 pl-7">
                    {businessGoals.length > 0 ? businessGoals.map((goalId) => {
                      ...
                      return (
                        <span key={goalId} className="bg-whatsapp/10 text-whatsapp text-xs px-3 py-1.5 rounded-full flex items-center">
          ...
          {currentStep === 6 && (
            <div className={`bg-white rounded-2xl shadow-md p-8 transition-all hover:shadow-lg
              ${currentStep === 6 ? 'border-2 border-whatsapp' : 'border border-gray-200'}`}>
              ...
              <div className="flex items-center bg-white rounded-3xl shadow-sm border border-gray-200 transition-all duration-300 focus-within:ring-2 focus-within:ring-whatsapp focus-within:border-transparent hover:border-whatsapp/50">
                <input
                  type="text"
                  value={userMessage}
                ...
                <button
                  ...
                  className={`p-4 rounded-r-3xl transition-all duration-300 ${
                    userMessage.trim() 
                      ? 'text-whatsapp hover:bg-gray-50 hover:text-whatsapp/80'
          ...
          {currentStep === 7 && (
            <div className={`bg-white rounded-2xl shadow-md p-8 transition-all hover:shadow-lg
              ${currentStep === 7 ? 'border-2 border-whatsapp' : 'border border-gray-200'}`}>
              <div className="text-center">
                ...
                <Link href="/playground">
                  <button 
                    className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-xl shadow-sm text-white bg-whatsapp hover:bg-whatsapp/90 transition-all transform hover:scale-105"
        ...
        <div className="mt-8 flex justify-between">
          ...
          {currentStep < 7 && (
            <button
              ...
              className={`ml-auto flex items-center px-4 py-2 rounded-xl text-sm font-medium transition-all ${
                canProceedToNextStep()
                  ? 'bg-whatsapp text-white hover:bg-whatsapp/90 shadow-md hover:shadow-lg'
