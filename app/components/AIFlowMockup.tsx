...
export default function AIFlowMockup() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
      ...
      <div className="bg-whatsapp px-4 py-2 flex items-center text-white">
      ...
      >
        ...
        {userMessage && (
          <div className="flex justify-end mb-2 animate-fade-in">
            <div className="bg-whatsapp-light rounded-lg p-3 text-sm max-w-[80%]">
          ...
          <div className="flex justify-start animate-fade-in-up">
            <div className="bg-white rounded-lg p-3 text-sm max-w-[80%] shadow-sm">
              ...
              <div className="space-y-2">
                <div className="bg-whatsapp bg-opacity-10 hover:bg-opacity-20 p-2 rounded-md cursor-pointer text-center text-whatsapp-dark">
      ...
      <div className="px-4 py-3 border-t flex items-center bg-white">
        ...
        />
        <button 
          className="px-4 py-2 rounded-r-md text-sm font-medium bg-whatsapp text-white hover:bg-whatsapp-dark"
        >
          Generate Flow
        </button>
      </div>
