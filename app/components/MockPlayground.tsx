      ...
      <div className="grid grid-cols-12 h-[400px] overflow-hidden">
        ...
        <div className="col-span-3 border-r flex flex-col bg-white">
          ...
          <div className="p-3 border-t flex bg-white">
            <input 
              ...
              className="text-sm flex-1 p-2 border rounded-l-md focus:outline-none focus:ring-1 focus:ring-whatsapp" 
            />
            <button className="bg-whatsapp text-white text-sm px-3 rounded-r-md hover:bg-whatsapp-dark transition-colors">
              Send
            </button>
          </div>
        </div>
        ...
        <div className="col-span-6 border-r relative bg-white">
          ...
          <div className="absolute bottom-4 right-4 flex space-x-2">
            <button className="bg-white text-whatsapp-dark border border-whatsapp text-sm px-3 py-1.5 rounded shadow-sm hover:bg-green-50 transition-colors">
              Export
            </button>
            <button className="bg-whatsapp text-white text-sm px-3 py-1.5 rounded shadow-sm hover:bg-whatsapp-dark transition-colors">
              Save Flow
            </button>
          </div>
        </div>
            ...
            {currentPreviewIndex === 1 && (
              ...
              >
                ...
                <div className="mt-3">
                  <input 
                    type="text" 
                    className="w-full border rounded p-2 text-sm focus:outline-none focus:ring-1 focus:ring-whatsapp" 
